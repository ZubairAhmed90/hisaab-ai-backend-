// HisaabAI — All AI System Prompts
// Import what you need: import { CATEGORIZE_PROMPT } from './prompts'

// ─── Transaction Categorizer ──────────────────────────────
// Used in: transactions.service.ts when user adds a transaction
...
// ─── Spending Advisor Chat ────────────────────────────────
// Used in: ai.service.ts for the chat feature
export const ADVISOR_PROMPT = (userData: {
  income: number
  totalSpent: number
  topCategory: string
  topAmount: number
...
// ─── Daily Tip Generator ──────────────────────────────────
// Used in: ai.service.ts for GET /ai/tips
export const DAILY_TIP_PROMPT = (category: string, amount: number, language: string) => `
...
// Used in: reports.service.ts
export const REPORT_PROMPT = (data: {
  grade: string
  budgetScore: number
  savingsScore: number
  topOverspend: string
...
// ─── Offer Matching Explainer ─────────────────────────────
// Used in: offers.service.ts — explain why offer was shown
export const OFFER_EXPLAIN_PROMPT = (category: string, offerTitle: string, language: string) => `
